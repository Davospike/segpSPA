...
<table style="width:100%">
    ...
    <tr>
        ...
        <td>Front-end</td>
        <td style="text-align: center;"><img src="Documentation/Images/HS%20Mugshot.jpg" style="width: 10px;height: 10px"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Back-end</td>
        <td style="text-align: center;"><img src="Documentation/Images/VG%20Mugshot.png" style="width: 10px;height: 10px"></td>
    </tr>
</table>
