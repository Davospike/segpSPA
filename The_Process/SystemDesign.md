...
The spread of fake news should be a worry for all and people should take an active role in teaching themselves how to recognise it. In one study it was found that humans are only 4% better than chance (50%) at distinguishing fact from fiction ([Bond & DePaulo, 2006](https://journals.sagepub.com/doi/pdf/10.1207/s15327957pspr1003_2)). It is important to try to increase those chances so people are less susceptible to fake news, and the best way to achieve this is to educate. 
...
There are ways for individuals to increase their chances of not falling victim to fake:
...
As with any new idea, *creativity requires influence* amongst other things. We were made aware of a website called [Gapminder](https://www.gapminder.org) which we eventually took influence from for our design and the overall semantics of our work. Gapminder is a well polished website that takes global, notable topics and asks though provoking questions about them. We wanted to do the same with *'Would They Lie to You?'* displaying an array of topics for the user to choose from. Below is how our paper prototype took influence from Gapminder.
...
Gapminder is great fun to visit and test yourself on global topics but there is also heavy emphasis on education and factual branches around its site. Building on this, we proposed a lot of areas to display fake news facts and statistics. Such as comprehensive landing page and further sections to learn about the history and influence on fake news, giving a holistic experience for the viewer.
