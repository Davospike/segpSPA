...
[ADD TO/REMOVE] - Discuss SDLC framework/ideas etc. - JACK
...
- Then, in the `docker-compose.yml`, we implemented the running of this `wait-for.sh` script in the command section (in services)
